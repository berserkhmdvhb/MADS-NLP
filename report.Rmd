...
## **Describe Dataset**
The dataset used for this project is president speeches ob.tained from [this link](https://www.presidency.ucsb.edu/documents/presidential-documents-archive-guidebook/inaugural-addresses).
...
//TODO: Perform doc similarity using the [textreuse](https://docs.ropensci.org/textreuse/) library.
...
```{r}
dtms[,1]
cosine_sim <- tcrossprod_simple_triplet_matrix(dtms[,1], dtms[,1])/sqrt(row_sums(dtms[,1]^2) %*% t(row_sums(dtms[,1]^2)))
